...
interface ArticuloClickListener{
    fun articuloClicked(articulo: Articulo)
}

class ArticulosRecyclerViewAdapter(val articulos: ArrayList<Articulo>, val listener: ArticuloClickListener) : Adapter<ArticulosViewHolder>(){
