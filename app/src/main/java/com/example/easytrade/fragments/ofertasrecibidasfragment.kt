...
import kotlinx.android.synthetic.main.fragment_misarticulosfragment.*
import kotlinx.android.synthetic.main.fragment_ofertasrecibidasfragment.*


class ofertasrecibidasfragment : Fragment(), ArticuloClickListener {
    ...
    override fun onCreateView(
        ...
        var retorno = inflater.inflate(R.layout.fragment_ofertasrecibidasfragment, container, false)
        val adaptador = ArticulosRecyclerViewAdapter(ArrayList<Articulo>(),this)
        val recycler = retorno.findViewById<RecyclerView>(R.id.rcvofertasarticulos)
        ...
        val listener = object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                datos?.let {
                    ...
                    val adapter = ArticulosRecyclerViewAdapter(artDat, this@ofertasrecibidasfragment)
                    rcvofertasarticulos.adapter = adapter
                }
            }
    ...
    override fun articuloClicked(articulo: Articulo) {
        val intent = Intent(context, aceptaroferta_activity::class.java)
